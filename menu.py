...
class Menu:
	...
	def display_money(self):
		...
		text_rect = text_surf.get_rect(midbottom = (SCREEN_WIDHT / 2,SCREEN_HEIGHT - 20))
	...
	def setup(self):
		...
		self.main_rect = pygame.Rect(SCREEN_WIDHT / 2 - self.width / 2,self.menu_top,self.width,self.total_height)
